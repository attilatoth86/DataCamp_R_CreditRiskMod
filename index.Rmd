...
set.seed(123)
train_idx <- sample(1:nrow(loan_data_nonOL_keepNA),2/3*nrow(loan_data_nonOL_keepNA))

loan_data_train <- loan_data_nonOL_keepNA[train_idx, ]
loan_data_test <- loan_data_nonOL_keepNA[-train_idx, ]
```
